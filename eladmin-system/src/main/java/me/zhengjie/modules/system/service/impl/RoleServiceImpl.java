...
import me.zhengjie.modules.system.constant.RoleConstant;
...
//    }
    ...
    public List<Role> getDefaultRoles() {
        Role defaultRole = findByName(RoleConstant.DEFAULT_ROLE);
        if (defaultRole == null) {
            defaultRole = new Role();
            defaultRole.setName(RoleConstant.DEFAULT_ROLE);
            defaultRole.setCreateTime(new Timestamp(System.currentTimeMillis()));
            defaultRole.setPermission(RoleConstant.DEFAULT_ROLE);
            RoleDto roleDto = create(defaultRole);
            defaultRole = roleMapper.toEntity(roleDto);
        }
